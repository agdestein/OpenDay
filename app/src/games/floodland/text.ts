...
interface Text {
  subtitle: string; build: string; storm: string; rewind: string; undo: string; reset: string;
...
const T: Localized<Text> = {
 ...
 modelHint:'Each cell stores depth and momentum. Arrows show flow. Pause, then advance one calculation step. Point at a cell to inspect it.',
 ...
 modelHint:'Elke cel bewaart diepte en impuls. Pijlen tonen de stroming. Pauzeer en ga één rekenstap verder. Wijs een cel aan om te kijken.',
 ...
 modelHint:'Hver celle lagrer dybde og impuls. Pilene viser strømmen. Sett på pause og gå ett beregningssteg videre. Pek på en celle for å undersøke.',
