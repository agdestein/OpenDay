...
const en: Text = {
  ...
  hintGuess: 'Colours: the computer’s best guess · Fog: where it is not sure',
  ...
  aboutFree: 'A real KNMI weather map is hidden under the fog. Every thermometer tells the computer the temperature in one spot, and it has to guess everything in between.',
  caseText: {
    hottest: {
      title: 'The hottest place',
      story: 'Heatwave! Somewhere in the Netherlands it is hottest of all. Find it with 8 thermometers. The colours show where it is probably warm; the fog shows where nobody knows yet.',
    ...
    map: {
      ...
      tip: 'Spreading out wins: each thermometer only knows its own neighbourhood. The computer put every thermometer where its fog was thickest.',
    },
    liars: {
...
const nl: Text = {
  ...
  hintGuess: 'Kleuren: de beste gok van de computer · Mist: waar hij het niet zeker weet',
  ...
  aboutFree: 'Onder de mist ligt een echte weerkaart van het KNMI. Elke thermometer vertelt de computer de temperatuur op één plek, en de rest moet hij raden.',
  caseText: {
    hottest: {
      title: 'De heetste plek',
      story: 'Hittegolf! Ergens in Nederland is het het allerheetst. Vind die plek met 8 thermometers. De kleuren tonen waar het waarschijnlijk warm is; de mist waar nog niemand het weet.',
    ...
    map: {
      ...
      tip: 'Verspreiden wint: elke thermometer kent alleen zijn eigen buurt. De computer zette elke thermometer waar zijn mist het dikst was.',
    },
    liars: {
...
const no: Text = {
  ...
  hintGuess: 'Farger: datamaskinens beste gjetning · Tåke: der den er usikker',
  ...
  aboutFree: 'Under tåka ligger et ekte værkart fra KNMI. Hvert termometer forteller datamaskinen temperaturen på ett sted, og resten må den gjette.',
  caseText: {
    hottest: {
      title: 'Det varmeste stedet',
      story: 'Hetebølge! Et sted i Nederland er det aller varmest. Finn det med 8 termometre. Fargene viser hvor det trolig er varmt; tåka viser hvor ingen vet ennå.',
    ...
    map: {
      ...
      tip: 'Å spre dem vinner: hvert termometer kjenner bare sitt eget nabolag. Datamaskinen satte hvert termometer der tåka var tykkest.',
    },
    liars: {
